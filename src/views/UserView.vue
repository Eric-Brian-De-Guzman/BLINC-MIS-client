...
<template>
  <aside id="sidebar"
    ...
    <div class="block w-2/3 mx-auto bg-csv border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
    ...
    <div class="h-full px-3 py-4 overflow-y-auto bg-violet dark:bg-gray-800">
      <ul class="space-y-2 font-medium">
        ...
        <li>
          <RouterLink to="/user/attendances"
            class="flex items-center p-2 text-white border-pink-300 text-s hover:bg-gradient-to-l from-grad hover:border-r-8">
        ...
        <li>
          <a href="/user/calendar" class="flex items-center p-2 text-white border-pink-300 text-s hover:bg-gradient-to-l from-grad hover:border-r-8">
            <img src="/calendar.svg" class="pr-3" alt="" />
            Calendar
          </a>
        </li>
        <li>
          <RouterLink to="/user/profile" class="flex items-center p-2 text-white border-pink-300 text-s hover:bg-gradient-to-l from-grad hover:border-r-8">
